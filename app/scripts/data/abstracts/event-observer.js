...
window.$GLOBAL_FUNCTIONS.AbstractEventObserver = (function () {
    ...
    AbstractEventObserver.prototype = Object.create({
        ...
        //, processQueue: {value: processQueue}
        //, processCallback: {value: processCallback}
    });

    return AbstractEventObserver;
