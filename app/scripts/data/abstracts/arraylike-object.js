...
window.$GLOBAL_FUNCTIONS.DynamicArrayAbstract = (function () {
    ...
    function Item(data, parent) {
        ...
        Object.defineProperties(this, {
            index: {
                get: function () {
                    const _this = this;
                    return (parent.array).findIndex(function (item) {
                        return item.data === _this.data;
                    });
                },
                enumerable: true
            }
