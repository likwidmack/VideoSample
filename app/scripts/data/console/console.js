/**
 * console file for ndp-video-spa on 31-Mar-16.
 */

window.$GLOBAL_FUNCTIONS._Console = (function () {
    window['console'] = window['console'] || undefined;
    if ('undefined' === typeof window['console']) window.console = {};

    var gv = window.$GLOBAL_PARAM;
    ...
    function _default(method) {
        var _method = this.__console__[method];
